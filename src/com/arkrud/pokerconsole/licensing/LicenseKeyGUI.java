...
public class LicenseKeyGUI extends javax.swing.JDialog {  
	...
	private final String internalString = "30-3-365";
	...
	/**
	 * OPTIONAL. This variable is used to check for valid maintenance period. If you defined a maintenance period in license then it will be valid for versions before maintenance period expires.
	 */
	 ...
	 */
	/**
	 * This is the file in which license key is saved. It is in user's home directory on disk. You may save it on database or in any other file if you like.
	 */
	private final String licenseKeyFileOnDisk = System.getProperty("user.home") + File.separator + "MyApplicationKey.lic";
	/**
	 * This is the file in which activated license text is saved. It is in user's home directory on disk. You may save it on database or in any other file if you like.
	 */
	...
	public LicenseKeyGUI(java.awt.Frame parent, boolean modal) {
		...
		/**
		 * We hide activate button first, then will show only if license key is valid but not activated.
		 */
	...
	public void dispose() {
		/**
		 * We easily override dispose() method here to exit main application if license is not valid. Maybe you can display an informative error message before exiting application.
		 */
	 ...
	 *
	 * First it checks for activated license text on disk. If license text file is not found on disk, then it checks for license key file on disk. Finally it updates GUI fields and returns license object.
	 */
	public License checkLicense() {
		try {
			/**
			 * We use Apache commons-io (FileUtils class) to easily read string from file.
			 */
			String licenseTextString = FileUtils.readFileToString(new File(licenseTextFileOnDisk));
			licenseObject = LicenseValidator.validate(licenseTextString, publicKey, productID, productEdition, productVersion, currentDate, currentVersionReleaseDate);
		...
		try {
			...
			licenseObject = LicenseValidator.validate(licenseKeyString, publicKey, internalString, nameforValidation, companyforValidation, hardwareIDMethod);
			updateGUIFieldsWithLicenseObject();
			return licenseObject;
		} catch (IOException ex) {
			Logger.getLogger(LicenseKeyGUI.class.getName()).log(Level.SEVERE, null, ex);
		...
		/**
		 * If there is no license key file or license text file, then it returns null here.
		 */
		return null;
	}
		...
		if (licenseObject != null) {
			...
			case LICENSE_VALID:
				if (licenseObject.isActivationCompleted()) {
					...
					/**
					 * License key is valid, but it is not activated so show "activate" button.
					 */
			...
			/**
			 * Since we use a license key with enabled activation and activation return type is a license text, we can check if license text is null. If it is not null, then set user information fields from
			 * license text.
			 */
			if (licenseObject.getLicenseText() != null) {
				...
				/**
				 * License Text is null, means it is not activated. So we clear GUI fields.
				 */
			...
			licenseStatusjTextField.setForeground(Color.red);
			/**
			 * No license; clear GUI fields if some information left from previous license...
			 */
			namejTextField.setText("");
			emailjTextField.setText("");
			companyjTextField.setText("");
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(20, 20, 20).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel2).addComponent(jLabel1))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(licenseExpirationDatejTextField).addComponent(licenseStatusjTextField)).addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel1).addComponent(licenseStatusjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2).addComponent(licenseExpirationDatejTextField,
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
				jPanel2Layout.createSequentialGroup().addGap(87, 87, 87)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel4, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel5, javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(jLabel6, javax.swing.GroupLayout.Alignment.TRAILING))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(namejTextField, javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(emailjTextField, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(companyjTextField, javax.swing.GroupLayout.Alignment.TRAILING))
						.addContainerGap()));
		jPanel2Layout
				.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
								...
								.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel5).addComponent(emailjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel6).addComponent(companyjTextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
								.addContainerGap()));
				...
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup().addComponent(progressjLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(deactivatejButton).addGap(7, 7, 7).addComponent(activatejButton).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(changeProductKeyjButton)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(closejButton))
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap()
				...
				.addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(closejButton).addComponent(changeProductKeyjButton).addComponent(activatejButton).addComponent(progressjLabel).addComponent(deactivatejButton))
				.addContainerGap()));
	...
	private void changeProductKeyjButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_changeProductKeyjButtonActionPerformed
		/**
		 * Basically we show an input dialog to get license key. It will be better to use a JDialog with required license key input fields.
		 */
		...
		if (key != null) {
			...
			/**
			 * First validate license and get a temporary license object to check for validation status later.
			 */
			License temporaryLicenseObject = LicenseValidator.validate(key, publicKey, internalString, nameforValidation, companyforValidation, hardwareIDMethod);
			/**
			 * If given license key is valid, then save it on disk, and update GUI fields.
			 */
			if (temporaryLicenseObject.getValidationStatus() == ValidationStatus.LICENSE_VALID) {
				licenseObject = temporaryLicenseObject;
				try {
					/**
					 * We use Apache commons-io (FileUtils class) to easily save string to file.
					 */
					FileUtils.writeStringToFile(new File(licenseKeyFileOnDisk), key);
					/**
					 * Since license key is changed delete license text file if exists on disk left from previous license key.
					 */
	...
	private void activatejButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_activatejButtonActionPerformed
		/**
		 * We use a SwingWorker here because it will connect to license server for activation, and it may take 2-3 seconds.
		 */
		SwingWorker<License, Void> worker = new SwingWorker<License, Void>() {
			...
			protected void done() {
				try {
					/**
					 * Again we get license object to a temporary object to check for ActivationStatus.
					 */
					License temporaryLicenseObject = (License) get();
					/**
					 * If it is successfully activated save on disk and update GUI fields.
					 */
					if (temporaryLicenseObject.getActivationStatus() == ActivationStatus.ACTIVATION_COMPLETED) {
						...
						try {
							 ...
							 * We use Apache commons-io (FileUtils class) to easily save string to file.
							 *
							 * licenseObject.getLicenseString() method returns activated license string.
							 */
						...
						/**
						 * If activation cannot be completed, display an error message.
						 */
			...
			protected License doInBackground() {
				/**
				 * Since example licenses are on Online.License4J the method below will activate on Online.License4J when autoActivate method is called without a license server address.
				 */
				return LicenseValidator.autoActivate(licenseObject);
				/**
				 * If you want to test your own "Auto License Generation and Activation Server" you should give its address as argument like below.
				 */
		...
		/**
		 * It is good to disable "activate" and "change product key" buttons while activation is in progress.
		 */
	...
	private void deactivatejButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_deactivatejButtonActionPerformed
		/**
		 * We use a SwingWorker here because it will connect to license server for deactivation, and it may take 2-3 seconds.
		 */
		SwingWorker<License, Void> worker = new SwingWorker<License, Void>() {
			@Override
			protected void done() {
				try {
					...
					if (temporaryLicenseObject.getActivationStatus() == ActivationStatus.DEACTIVATION_COMPLETED) {
						/**
						 * We use Apache commons-io (FileUtils class) to easily delete activated license text on disk.
						 */
						FileUtils.deleteQuietly(new File(licenseTextFileOnDisk));
						/**
						 * After deleting activated license text on disk, we call checkLicense method again to update licenseObject with current license status etc.
						 */
			...
			protected License doInBackground() {
				/**
				 * Since example licenses are on Online.License4J the method below will deactivate on Online.License4J when autoDeactivate method is called without a license server address.
				 */
		...
		/**
		 * It is good to disable "deactivate" "activate" and "change product key" buttons while activation is in progress.
		 */
