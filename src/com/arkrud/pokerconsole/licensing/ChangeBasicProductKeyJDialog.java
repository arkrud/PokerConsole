/**
 * This is simple GUI to get 25 characters license key.
 */
...
public class ChangeBasicProductKeyJDialog extends javax.swing.JDialog {
    ...
    private void okjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okjButtonActionPerformed
        if (jTextField1.getText() == null || jTextField1.getText().length() < 5
                || jTextField2.getText() == null || jTextField2.getText().length() < 5
                || jTextField3.getText() == null || jTextField3.getText().length() < 5
                || jTextField4.getText() == null || jTextField4.getText().length() < 5
                || jTextField5.getText() == null || jTextField5.getText().length() < 5) {
